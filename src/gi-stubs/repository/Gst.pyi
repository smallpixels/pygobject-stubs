...
def buffer_list_replace(new_list: typing.Optional[BufferList] = None) -> typing.Tuple[bool, BufferList]: ...
def buffer_list_take(new_list: typing.Optional[BufferList] = None) -> typing.Tuple[bool, BufferList]: ...
...
def context_replace(new_context: typing.Optional[Context] = None) -> typing.Tuple[bool, Context]: ...
...
def debug_log_default(category: DebugCategory, level: DebugLevel, file: str, function: str, line: int, object: typing.Optional[GObject.Object], message: DebugMessage, user_data: None) -> None: ...
def debug_log_get_line(category: DebugCategory, level: DebugLevel, file: str, function: str, line: int, object: typing.Optional[GObject.Object], message: DebugMessage) -> str: ...
def debug_log_id_literal(category: DebugCategory, level: DebugLevel, file: str, function: str, line: int, id: typing.Optional[str], message_string: str) -> None: ...
def debug_log_literal(category: DebugCategory, level: DebugLevel, file: str, function: str, line: int, object: typing.Optional[GObject.Object], message_string: str) -> None: ...
...
def init(argv=None): ... # FIXME Function
def init_check(argv): ... # FIXME Function
...
def message_take(new_message: typing.Optional[Message] = None) -> typing.Tuple[bool, Message]: ...
...
def meta_api_type_register(api: str, tags: typing.Sequence[str]) -> typing.Type[typing.Any]: ...
def meta_deserialize(buffer: Buffer, data: int, size: int) -> typing.Tuple[typing.Optional[Meta], int]: ...
def meta_get_info(impl: str) -> typing.Optional[MetaInfo]: ...
def meta_register_custom(name: str, tags: typing.Sequence[str], transform_func: typing.Optional[typing.Callable[..., bool]] = None, *user_data: typing.Any) -> MetaInfo: ...
def meta_register_custom_simple(name: str) -> MetaInfo: ...
def mini_object_replace(newdata: typing.Optional[MiniObject] = None) -> typing.Tuple[bool, MiniObject]: ...
...
def param_spec_fraction(name: str, nick: str, blurb: str, min_num: int, min_denom: int, max_num: int, max_denom: int, default_num: int, default_denom: int, flags: GObject.ParamFlags) -> typing.Optional[GObject.ParamSpec]: ...
...
def parse_bin_from_description_full(bin_description: str, ghost_unlinked_pads: bool, context: typing.Optional[ParseContext], flags: ParseFlags) -> Element: ...
def parse_error_quark() -> int: ...
def parse_launch(pipeline_description: str) -> Element: ...
def parse_launch_full(pipeline_description: str, context: typing.Optional[ParseContext], flags: ParseFlags) -> Element: ...
def parse_launchv(argv: typing.Sequence[str]) -> Element: ...
def parse_launchv_full(argv: typing.Sequence[str], context: typing.Optional[ParseContext], flags: ParseFlags) -> Element: ...
def plugin_error_quark() -> int: ...
def preset_get_app_dir() -> typing.Optional[str]: ...
def preset_set_app_dir(app_dir: str) -> bool: ...
def protection_filter_systems_by_available_decryptors(system_identifiers: typing.Sequence[str]) -> typing.Optional[list[str]]: ...
def protection_meta_api_get_type() -> typing.Type[typing.Any]: ...
def protection_meta_get_info() -> MetaInfo: ...
def protection_select_system(system_identifiers: typing.Sequence[str]) -> typing.Optional[str]: ...
def query_take(new_query: typing.Optional[Query] = None) -> typing.Tuple[bool, Query]: ...
...
def static_caps_get_type() -> typing.Type[typing.Any]: ...
def static_pad_template_get_type() -> typing.Type[typing.Any]: ...
def stream_error_quark() -> int: ...
def stream_type_get_name(stype: StreamType) -> str: ...
def structure_take(newstr: typing.Optional[Structure] = None) -> typing.Tuple[bool, Structure]: ...
...
def tag_list_replace(new_taglist: typing.Optional[TagList] = None) -> typing.Tuple[bool, TagList]: ...
def tag_list_take(new_taglist: typing.Optional[TagList] = None) -> typing.Tuple[bool, TagList]: ...
...
def tracing_register_hook(tracer: Tracer, detail: str, func: typing.Callable[[], None]) -> None: ...
def type_find_get_type() -> typing.Type[typing.Any]: ...
def type_find_register(plugin: typing.Optional[Plugin], name: str, rank: int, func: typing.Callable[..., None], extensions: typing.Optional[str] = None, possible_caps: typing.Optional[Caps] = None, *data: typing.Any) -> bool: ...
def type_is_plugin_api(type: typing.Type[typing.Any]) -> typing.Tuple[bool, PluginAPIFlags]: ...
def type_mark_as_plugin_api(type: typing.Type[typing.Any], flags: PluginAPIFlags) -> None: ...
...
def util_array_binary_search(array: None, num_elements: int, element_size: int, search_func: typing.Callable[..., int], mode: SearchMode, search_data: None, *user_data: typing.Any) -> None: ...
...
def util_fraction_add(a_n: int, a_d: int, b_n: int, b_d: int) -> typing.Tuple[bool, int, int]: ...
def util_fraction_compare(a_n: int, a_d: int, b_n: int, b_d: int) -> int: ...
def util_fraction_multiply(a_n: int, a_d: int, b_n: int, b_d: int) -> typing.Tuple[bool, int, int]: ...
def util_fraction_to_double(src_n: int, src_d: int) -> float: ...
def util_gdouble_to_guint64(value: float) -> int: ...
def util_get_object_array(object: GObject.Object, name: str) -> typing.Tuple[bool, GObject.ValueArray]: ...
...
def util_simplify_fraction(numerator: int, denominator: int, n_terms: int, threshold: int) -> None: ...
...
def value_deserialize_with_pspec(src: str, pspec: typing.Optional[GObject.ParamSpec] = None) -> typing.Tuple[bool, typing.Any]: ...
def value_fixate(dest: typing.Any, src: typing.Any) -> bool: ...
def value_fraction_multiply(product: typing.Any, factor1: typing.Any, factor2: typing.Any) -> bool: ...
def value_fraction_subtract(dest: typing.Any, minuend: typing.Any, subtrahend: typing.Any) -> bool: ...
...
def value_intersect(value1: typing.Any, value2: typing.Any) -> typing.Tuple[bool, typing.Any]: ...
...
def value_set_fraction_range(value: typing.Any, start: typing.Any, end: typing.Any) -> None: ...
def value_set_fraction_range_full(value: typing.Any, numerator_start: int, denominator_start: int, numerator_end: int, denominator_end: int) -> None: ...
def value_set_int64_range(value: typing.Any, start: int, end: int) -> None: ...
def value_set_int64_range_step(value: typing.Any, start: int, end: int, step: int) -> None: ...
def value_set_int_range(value: typing.Any, start: int, end: int) -> None: ...
def value_set_int_range_step(value: typing.Any, start: int, end: int, step: int) -> None: ...
def value_set_structure(value: typing.Any, structure: Structure) -> None: ...
def value_subtract(minuend: typing.Any, subtrahend: typing.Any) -> typing.Tuple[bool, typing.Any]: ...
def value_union(value1: typing.Any, value2: typing.Any) -> typing.Tuple[bool, typing.Any]: ...
...
class Allocator(Object):
    ...
    def __init__(self, name: typing.Optional[str] = ...,
                 parent: Object = ...) -> None: ...
    def alloc(self, size: int, params: typing.Optional[AllocationParams] = None) -> typing.Optional[Memory]: ...
...
class Bin(Element, ChildProxy):
    ...
    def get_by_interface(self, iface: typing.Type[typing.Any]) -> typing.Optional[Element]: ...
    ...
    def iterate_all_by_element_factory_name(self, factory_name: str) -> typing.Optional[Iterator]: ...
    def iterate_all_by_interface(self, iface: typing.Type[typing.Any]) -> typing.Optional[Iterator]: ...
...
class Buffer(GObject.GBoxed):
    ...
    def add_parent_buffer_meta(self, ref: Buffer) -> typing.Optional[ParentBufferMeta]: ...
    def add_protection_meta(self, info: Structure) -> ProtectionMeta: ...
    def add_reference_timestamp_meta(self, reference: Caps, timestamp: int, duration: int) -> typing.Optional[ReferenceTimestampMeta]: ...
    ...
    def copy_region(self, flags: BufferCopyFlags, offset: int, size: int) -> typing.Optional[Buffer]: ...
    ...
    def find_memory(self, offset: int, size: int) -> typing.Tuple[bool, int, int, int]: ...
    def foreach_meta(self, func: typing.Callable[..., typing.Tuple[bool, Meta]], *user_data: typing.Any) -> bool: ...
    ...
    def get_reference_timestamp_meta(self, reference: typing.Optional[Caps] = None) -> typing.Optional[ReferenceTimestampMeta]: ...
    ...
    def new(cls) -> Buffer: ...
    @classmethod
    def new_allocate(cls, allocator: typing.Optional[Allocator], size: int, params: typing.Optional[AllocationParams] = None) -> typing.Optional[Buffer]: ...
    @classmethod
    ...
    @classmethod
    def new_wrapped_full(cls, flags: MemoryFlags, data: typing.Sequence[int], maxsize: int, offset: int, user_data: None, notify: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> Buffer: ...
...
class BufferList(GObject.GBoxed):
    ...
    def foreach(self, func: typing.Callable[..., typing.Tuple[bool, Buffer]], *user_data: typing.Any) -> bool: ...
    def get(self, idx: int) -> typing.Optional[Buffer]: ...
    def get_writable(self, idx: int) -> typing.Optional[Buffer]: ...
    ...
    @staticmethod
    def replace(new_list: typing.Optional[BufferList] = None) -> typing.Tuple[bool, BufferList]: ...
    @staticmethod
    def take(new_list: typing.Optional[BufferList] = None) -> typing.Tuple[bool, BufferList]: ...
...
class BufferPool(Object):
    ...
    def __init__(self, name: typing.Optional[str] = ...,
                 parent: Object = ...) -> None: ...
    def acquire_buffer(self, params: typing.Optional[BufferPoolAcquireParams] = None) -> typing.Tuple[FlowReturn, Buffer]: ...
    @staticmethod
    def config_add_option(config: Structure, option: str) -> None: ...
    @staticmethod
    def config_get_allocator(config: Structure) -> typing.Tuple[bool, Allocator, AllocationParams]: ...
    @staticmethod
    def config_get_option(config: Structure, index: int) -> typing.Optional[str]: ...
    @staticmethod
    def config_get_params(config: Structure) -> typing.Tuple[bool, Caps, int, int, int]: ...
    @staticmethod
    def config_has_option(config: Structure, option: str) -> bool: ...
    @staticmethod
    def config_n_options(config: Structure) -> int: ...
    @staticmethod
    def config_set_allocator(config: Structure, allocator: typing.Optional[Allocator] = None, params: typing.Optional[AllocationParams] = None) -> None: ...
    @staticmethod
    def config_set_params(config: Structure, caps: typing.Optional[Caps], size: int, min_buffers: int, max_buffers: int) -> None: ...
    @staticmethod
    def config_validate_params(config: Structure, caps: typing.Optional[Caps], size: int, min_buffers: int, max_buffers: int) -> bool: ...
...
class Bus(Object):
    ...
    def add_watch(self, priority: int, func: typing.Callable[..., bool], *user_data: typing.Any) -> int: ...
    ...
    def set_flushing(self, flushing: bool) -> None: ...
    def set_sync_handler(self, func: typing.Optional[typing.Callable[..., BusSyncReply]] = None, *user_data: typing.Any) -> None: ...
    ...
    def timed_pop_filtered(self, timeout: int, types: MessageType) -> typing.Optional[Message]: ...
...
class Caps(GObject.GBoxed):
    ...
    def append_structure_full(self, structure: Structure, features: typing.Optional[CapsFeatures] = None) -> None: ...
    def can_intersect(self, caps2: Caps) -> bool: ...
    def copy(self) -> Caps: ...
    def copy_nth(self, nth: int) -> Caps: ...
    def filter_and_map_in_place(self, func: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
    def fixate(self) -> Caps: ...
    def foreach(self, func: typing.Callable[..., bool], *user_data: typing.Any) -> bool: ...
    @staticmethod
    ...
    def is_subset_structure_full(self, structure: Structure, features: typing.Optional[CapsFeatures] = None) -> bool: ...
    def map_in_place(self, func: typing.Callable[..., bool], *user_data: typing.Any) -> bool: ...
    def merge(self, caps2: Caps) -> Caps: ...
    def merge_structure(self, structure: Structure) -> Caps: ...
    def merge_structure_full(self, structure: Structure, features: typing.Optional[CapsFeatures] = None) -> Caps: ...
    @classmethod
    ...
    def set_features(self, index: int, features: typing.Optional[CapsFeatures] = None) -> None: ...
    def set_features_simple(self, features: typing.Optional[CapsFeatures] = None) -> None: ...
...
class ChildProxy(GObject.GInterface):
    ...
    def get_child_by_name_recurse(self, name: str) -> typing.Optional[GObject.Object]: ...
    def get_children_count(self) -> int: ...
    def get_property(self, name: str) -> typing.Any: ...
    def lookup(self, name: str) -> typing.Tuple[bool, GObject.Object, GObject.ParamSpec]: ...
...
class Clock(Object):
    ...
    def __init__(self, timeout: int = ...,
                 ...
                 name: typing.Optional[str] = ...,
                 parent: Object = ...) -> None: ...
    def add_observation(self, slave: int, master: int) -> typing.Tuple[bool, float]: ...
    def add_observation_unapplied(self, slave: int, master: int) -> typing.Tuple[bool, float, int, int, int, int]: ...
    ...
    @staticmethod
    def id_wait_async(id: None, func: typing.Callable[..., bool], *user_data: typing.Any) -> ClockReturn: ...
...
class Context(GObject.GBoxed):
    ...
    @staticmethod
    def replace(new_context: typing.Optional[Context] = None) -> typing.Tuple[bool, Context]: ...
    def unref(self) -> None: ...
...
class ControlBinding(Object):
    ...
    def get_g_value_array(self, timestamp: int, interval: int, values: typing.Sequence[typing.Any]) -> bool: ...
...
class ControlSource(Object):
    ...
    def control_source_get_value_array(self, timestamp: int, interval: int, values: typing.Sequence[float]) -> bool: ...
...
class DateTime(GObject.GBoxed):
    ...
    @classmethod
    def new(cls, tzoffset: float, year: int, month: int, day: int, hour: int, minute: int, seconds: float) -> typing.Optional[DateTime]: ...
    @classmethod
    def new_from_g_date_time(cls, dt: typing.Optional[GLib.DateTime] = None) -> typing.Optional[DateTime]: ...
    @classmethod
    ...
    @classmethod
    def new_from_unix_epoch_local_time_usecs(cls, usecs: int) -> typing.Optional[DateTime]: ...
    @classmethod
    ...
    @classmethod
    def new_local_time(cls, year: int, month: int, day: int, hour: int, minute: int, seconds: float) -> typing.Optional[DateTime]: ...
    @classmethod
...
class Device(Object):
    ...
    def __init__(self, caps: Caps = ...,
                 ...
                 name: typing.Optional[str] = ...,
                 parent: Object = ...) -> None: ...
    def create_element(self, name: typing.Optional[str] = None) -> typing.Optional[Element]: ...
...
class DeviceMonitor(Object):
    ...
    def __init__(self, show_all: bool = ...,
                 name: typing.Optional[str] = ...,
                 parent: Object = ...) -> None: ...
    def add_filter(self, classes: typing.Optional[str] = None, caps: typing.Optional[Caps] = None) -> int: ...
...
class DeviceProvider(Object):
    ...
    @staticmethod
    def register(plugin: typing.Optional[Plugin], name: str, rank: int, type: typing.Type[typing.Any]) -> bool: ...
...
class DeviceProviderFactory(PluginFeature):
    ...
    def has_classesv(self, classes: typing.Optional[typing.Sequence[str]] = None) -> bool: ...
    @staticmethod
...
class Element(Object):
    ...
    def add_property_deep_notify_watch(self, property_name: typing.Optional[str], include_value: bool) -> int: ...
    def add_property_notify_watch(self, property_name: typing.Optional[str], include_value: bool) -> int: ...
    def add_static_metadata(self, key: str, value: str) -> None: ...
    ...
    def call_async(self, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    ...
    def foreach_pad(self, func: typing.Callable[..., bool], *user_data: typing.Any) -> bool: ...
    def foreach_sink_pad(self, func: typing.Callable[..., bool], *user_data: typing.Any) -> bool: ...
    def foreach_src_pad(self, func: typing.Callable[..., bool], *user_data: typing.Any) -> bool: ...
    def get_base_time(self) -> int: ...
    def get_bus(self) -> typing.Optional[Bus]: ...
    def get_clock(self) -> typing.Optional[Clock]: ...
    def get_compatible_pad(self, pad: Pad, caps: typing.Optional[Caps] = None) -> typing.Optional[Pad]: ...
    def get_compatible_pad_template(self, compattempl: PadTemplate) -> typing.Optional[PadTemplate]: ...
    ...
    def get_state(self, timeout: int) -> typing.Tuple[StateChangeReturn, State, State]: ...
    ...
    def link_filtered(self, dest: Element, filter: typing.Optional[Caps] = None) -> bool: ...
    def link_many(*args): ... # FIXME Function
    def link_pads(self, srcpadname: typing.Optional[str], dest: Element, destpadname: typing.Optional[str] = None) -> bool: ...
    def link_pads_filtered(self, srcpadname: typing.Optional[str], dest: Element, destpadname: typing.Optional[str] = None, filter: typing.Optional[Caps] = None) -> bool: ...
    def link_pads_full(self, srcpadname: typing.Optional[str], dest: Element, destpadname: typing.Optional[str], flags: PadLinkCheck) -> bool: ...
    def lost_state(self) -> None: ...
    @staticmethod
    def make_from_uri(type: URIType, uri: str, elementname: typing.Optional[str] = None) -> Element: ...
    def message_full(self, type: MessageType, domain: int, code: int, text: typing.Optional[str], debug: typing.Optional[str], file: str, function: str, line: int) -> None: ...
    def message_full_with_details(self, type: MessageType, domain: int, code: int, text: typing.Optional[str], debug: typing.Optional[str], file: str, function: str, line: int, structure: Structure) -> None: ...
    def no_more_pads(self) -> None: ...
    def post_message(self, message: Message) -> bool: ...
    def provide_clock(self) -> typing.Optional[Clock]: ...
    def query(self, query: Query) -> bool: ...
    def query_convert(self, src_format: Format, src_val: int, dest_format: Format) -> typing.Tuple[bool, int]: ...
    ...
    def request_pad(self, templ: PadTemplate, name: typing.Optional[str] = None, caps: typing.Optional[Caps] = None) -> typing.Optional[Pad]: ...
...
class ElementFactory(PluginFeature):
    ...
    def create_with_properties(self, names: typing.Optional[typing.Sequence[str]] = None, values: typing.Optional[typing.Sequence[typing.Any]] = None) -> typing.Optional[Element]: ...
    @staticmethod
    ...
    @staticmethod
    def make(factoryname: str, name: typing.Optional[str] = None) -> typing.Optional[Element]: ...
    @staticmethod
    def make_with_properties(factoryname: str, names: typing.Optional[typing.Sequence[str]] = None, values: typing.Optional[typing.Sequence[typing.Any]] = None) -> typing.Optional[Element]: ...
...
class Event(GObject.GBoxed):
    ...
    @classmethod
    def new_buffer_size(cls, format: Format, minsize: int, maxsize: int, async: bool) -> Event: ...
    @classmethod
    ...
    def parse_seek(self) -> typing.Tuple[float, Format, SeekFlags, SeekType, int, SeekType, int]: ...
...
class GhostPad(ProxyPad):
    ...
    def __init__(self, direction: PadDirection = ...,
                 ...
                 parent: Object = ...) -> None: ...
    @staticmethod
    def activate_mode_default(pad: Pad, parent: typing.Optional[Object], mode: PadMode, active: bool) -> bool: ...
    def construct(self) -> bool: ...
    def get_target(self) -> typing.Optional[Pad]: ...
    @staticmethod
    def internal_activate_mode_default(pad: Pad, parent: typing.Optional[Object], mode: PadMode, active: bool) -> bool: ...
    @classmethod
    def new(cls, name: typing.Optional[str], target: Pad) -> GhostPad: ...
    @classmethod
    def new_from_template(cls, name: typing.Optional[str], target: Pad, templ: PadTemplate) -> GhostPad: ...
    @classmethod
    def new_no_target(cls, name: typing.Optional[str], dir: PadDirection) -> GhostPad: ...
    @classmethod
    def new_no_target_from_template(cls, name: typing.Optional[str], templ: PadTemplate) -> GhostPad: ...
...
class Iterator(GObject.GBoxed):
    ...
    def filter(self, func: typing.Callable[[None, None], int], user_data: typing.Any) -> Iterator: ...
    def find_custom(self, func: typing.Callable[..., int], *user_data: typing.Any) -> typing.Tuple[bool, typing.Any]: ...
    def fold(self, func: typing.Callable[..., bool], ret: typing.Any, *user_data: typing.Any) -> IteratorResult: ...
    def foreach(self, func: typing.Callable[..., None], *user_data: typing.Any) -> IteratorResult: ...
    def free(self) -> None: ...
    @classmethod
    def new_single(cls, type: typing.Type[typing.Any], object: typing.Any) -> Iterator: ...
...
class Memory(GObject.GBoxed):
    ...
    def make_mapped(self, flags: MapFlags) -> typing.Tuple[typing.Optional[Memory], MapInfo]: ...
    def map(self, flags): ... # FIXME Function
    @classmethod
    def new_wrapped(cls, flags: MemoryFlags, data: typing.Sequence[int], maxsize: int, offset: int, user_data: None, notify: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> typing.Optional[Memory]: ...
    def resize(self, offset: int, size: int) -> None: ...
...
class Message(GObject.GBoxed):
    ...
    lock: GLib.Mutex = ...
    cond: GLib.Cond = ...
    def add_redirect_entry(self, location: str, tag_list: typing.Optional[TagList] = None, entry_struct: typing.Optional[Structure] = None) -> None: ...
    ...
    def has_name(self, name: str) -> bool: ...
    @classmethod
    def new_application(cls, src: typing.Optional[Object], structure: Structure) -> Message: ...
    @classmethod
    def new_async_done(cls, src: typing.Optional[Object], running_time: int) -> Message: ...
    @classmethod
    ...
    @classmethod
    def new_clock_provide(cls, src: typing.Optional[Object], clock: Clock, ready: bool) -> Message: ...
    @classmethod
    def new_custom(cls, type: MessageType, src: typing.Optional[Object] = None, structure: typing.Optional[Structure] = None) -> Message: ...
    @classmethod
    def new_device_added(cls, src: typing.Optional[Object], device: Device) -> Message: ...
    @classmethod
    def new_device_changed(cls, src: typing.Optional[Object], device: Device, changed_device: Device) -> Message: ...
    @classmethod
    def new_device_removed(cls, src: typing.Optional[Object], device: Device) -> Message: ...
    @classmethod
    def new_duration_changed(cls, src: typing.Optional[Object] = None) -> Message: ...
    @classmethod
    def new_element(cls, src: typing.Optional[Object], structure: Structure) -> Message: ...
    @classmethod
    def new_eos(cls, src: typing.Optional[Object] = None) -> Message: ...
    @classmethod
    def new_error(cls, src: typing.Optional[Object], error: GLib.Error, debug: str) -> Message: ...
    @classmethod
    def new_error_with_details(cls, src: typing.Optional[Object], error: GLib.Error, debug: str, details: typing.Optional[Structure] = None) -> Message: ...
    @classmethod
    def new_have_context(cls, src: typing.Optional[Object], context: Context) -> Message: ...
    @classmethod
    def new_info(cls, src: typing.Optional[Object], error: GLib.Error, debug: str) -> Message: ...
    @classmethod
    def new_info_with_details(cls, src: typing.Optional[Object], error: GLib.Error, debug: str, details: typing.Optional[Structure] = None) -> Message: ...
    @classmethod
    def new_instant_rate_request(cls, src: typing.Optional[Object], rate_multiplier: float) -> Message: ...
    @classmethod
    def new_latency(cls, src: typing.Optional[Object] = None) -> Message: ...
    @classmethod
    def new_need_context(cls, src: typing.Optional[Object], context_type: str) -> Message: ...
    @classmethod
    def new_new_clock(cls, src: typing.Optional[Object], clock: Clock) -> Message: ...
    @classmethod
    def new_progress(cls, src: typing.Optional[Object], type: ProgressType, code: str, text: str) -> Message: ...
    @classmethod
    def new_property_notify(cls, src: Object, property_name: str, val: typing.Optional[typing.Any] = None) -> Message: ...
    @classmethod
    def new_qos(cls, src: typing.Optional[Object], live: bool, running_time: int, stream_time: int, timestamp: int, duration: int) -> Message: ...
    @classmethod
    def new_redirect(cls, src: typing.Optional[Object], location: str, tag_list: typing.Optional[TagList] = None, entry_struct: typing.Optional[Structure] = None) -> Message: ...
    @classmethod
    def new_request_state(cls, src: typing.Optional[Object], state: State) -> Message: ...
    @classmethod
    def new_reset_time(cls, src: typing.Optional[Object], running_time: int) -> Message: ...
    @classmethod
    def new_segment_done(cls, src: typing.Optional[Object], format: Format, position: int) -> Message: ...
    @classmethod
    def new_segment_start(cls, src: typing.Optional[Object], format: Format, position: int) -> Message: ...
    @classmethod
    def new_state_changed(cls, src: typing.Optional[Object], oldstate: State, newstate: State, pending: State) -> Message: ...
    @classmethod
    def new_state_dirty(cls, src: typing.Optional[Object] = None) -> Message: ...
    @classmethod
    def new_step_done(cls, src: typing.Optional[Object], format: Format, amount: int, rate: float, flush: bool, intermediate: bool, duration: int, eos: bool) -> Message: ...
    @classmethod
    def new_step_start(cls, src: typing.Optional[Object], active: bool, format: Format, amount: int, rate: float, flush: bool, intermediate: bool) -> Message: ...
    @classmethod
    def new_stream_collection(cls, src: typing.Optional[Object], collection: StreamCollection) -> Message: ...
    @classmethod
    def new_stream_start(cls, src: typing.Optional[Object] = None) -> Message: ...
    @classmethod
    def new_stream_status(cls, src: typing.Optional[Object], type: StreamStatusType, owner: Element) -> Message: ...
    @classmethod
    def new_streams_selected(cls, src: typing.Optional[Object], collection: StreamCollection) -> Message: ...
    @classmethod
    def new_structure_change(cls, src: typing.Optional[Object], type: StructureChangeType, owner: Element, busy: bool) -> Message: ...
    @classmethod
    def new_tag(cls, src: typing.Optional[Object], tag_list: TagList) -> Message: ...
    @classmethod
    def new_toc(cls, src: typing.Optional[Object], toc: Toc, updated: bool) -> Message: ...
    @classmethod
    def new_warning(cls, src: typing.Optional[Object], error: GLib.Error, debug: str) -> Message: ...
    @classmethod
    def new_warning_with_details(cls, src: typing.Optional[Object], error: GLib.Error, debug: str, details: typing.Optional[Structure] = None) -> Message: ...
    ...
    def parse_redirect_entry(self, entry_index: int) -> typing.Tuple[str, TagList, Structure]: ...
    ...
    def parse_step_done(self) -> typing.Tuple[Format, int, float, bool, bool, int, bool]: ...
    def parse_step_start(self) -> typing.Tuple[bool, Format, int, float, bool, bool]: ...
    def parse_stream_collection(self) -> StreamCollection: ...
    def parse_stream_status(self) -> typing.Tuple[StreamStatusType, Element]: ...
    def parse_streams_selected(self) -> StreamCollection: ...
    def parse_structure_change(self) -> typing.Tuple[StructureChangeType, Element, bool]: ...
    def parse_tag(self) -> TagList: ...
    def parse_toc(self) -> typing.Tuple[Toc, bool]: ...
    ...
    @staticmethod
    def take(new_message: typing.Optional[Message] = None) -> typing.Tuple[bool, Message]: ...
    def writable_structure(self) -> Structure: ...
...
class Meta(GObject.GPointer):
    ...
    @staticmethod
    def api_type_register(api: str, tags: typing.Sequence[str]) -> typing.Type[typing.Any]: ...
    def compare_seqnum(self, meta2: Meta) -> int: ...
    @staticmethod
    def deserialize(buffer: Buffer, data: int, size: int) -> typing.Tuple[typing.Optional[Meta], int]: ...
    @staticmethod
    def get_info(impl: str) -> typing.Optional[MetaInfo]: ...
    def get_seqnum(self) -> int: ...
    @staticmethod
    def register_custom(name: str, tags: typing.Sequence[str], transform_func: typing.Optional[typing.Callable[..., bool]] = None, *user_data: typing.Any) -> MetaInfo: ...
    @staticmethod
...
class MiniObject(GObject.GBoxed):
    ...
    @staticmethod
    def replace(newdata: typing.Optional[MiniObject] = None) -> typing.Tuple[bool, MiniObject]: ...
    def set_qdata(self, quark: int, data: None, destroy: typing.Callable[[None], None]) -> None: ...
...
class Object(GObject.InitiallyUnowned):
    ...
    @staticmethod
    def default_deep_notify(object: GObject.Object, orig: Object, pspec: GObject.ParamSpec, excluded_props: typing.Optional[typing.Sequence[str]] = None) -> None: ...
    def default_error(self, error: GLib.Error, debug: typing.Optional[str] = None) -> None: ...
    def do_deep_notify(self, orig: Object, pspec: GObject.ParamSpec) -> None: ...
    def get_control_binding(self, property_name: str) -> typing.Optional[ControlBinding]: ...
    def get_control_rate(self) -> int: ...
    def get_g_value_array(self, property_name: str, timestamp: int, interval: int, values: typing.Sequence[typing.Any]) -> bool: ...
    def get_name(self) -> typing.Optional[str]: ...
    def get_parent(self) -> typing.Optional[Object]: ...
    def get_path_string(self) -> str: ...
    def get_value(self, property_name: str, timestamp: int) -> typing.Optional[typing.Any]: ...
    ...
    @staticmethod
    def replace(newobj: typing.Optional[Object] = None) -> typing.Tuple[bool, Object]: ...
...
class Pad(Object):
    ...
    def add_probe(self, mask: PadProbeType, callback: typing.Callable[..., PadProbeReturn], *user_data: typing.Any) -> int: ...
    ...
    def create_stream_id(self, parent: Element, stream_id: typing.Optional[str] = None) -> str: ...
    ...
    def forward(self, forward: typing.Callable[..., bool], *user_data: typing.Any) -> bool: ...
    ...
    def get_sticky_event(self, event_type: EventType, idx: int) -> typing.Optional[Event]: ...
    ...
    def iterate_internal_links_default(self, parent: typing.Optional[Object] = None) -> typing.Optional[Iterator]: ...
    ...
    @classmethod
    def new_from_template(cls, templ: PadTemplate, name: typing.Optional[str] = None) -> Pad: ...
    ...
    def peer_query_convert(self, src_format: Format, src_val: int, dest_format: Format) -> typing.Tuple[bool, int]: ...
    ...
    def pull_range(self, offset: int, size: int) -> typing.Tuple[FlowReturn, Buffer]: ...
    ...
    def send_event(self, event: Event) -> bool: ...
    def set_activate_function_full(self, activate: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
    def set_activatemode_function_full(self, activatemode: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
    def set_active(self, active: bool) -> bool: ...
    def set_caps(self, caps): ... # FIXME Function
    def set_chain_function(self, func): ... # FIXME Function
    def set_chain_function_full(self, chain: typing.Callable[..., FlowReturn], *user_data: typing.Any) -> None: ...
    def set_chain_list_function_full(self, chainlist: typing.Callable[..., FlowReturn], *user_data: typing.Any) -> None: ...
    def set_element_private(self, priv: None) -> None: ...
    def set_event_full_function_full(self, event: typing.Callable[..., FlowReturn], *user_data: typing.Any) -> None: ...
    def set_event_function(self, func): ... # FIXME Function
    def set_event_function_full(self, event: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
    def set_getrange_function_full(self, get: typing.Callable[..., FlowReturn], *user_data: typing.Any) -> None: ...
    def set_iterate_internal_links_function_full(self, iterintlink: typing.Callable[..., Iterator], *user_data: typing.Any) -> None: ...
    def set_link_function_full(self, link: typing.Callable[..., PadLinkReturn], *user_data: typing.Any) -> None: ...
    def set_offset(self, offset: int) -> None: ...
    def set_query_function(self, func): ... # FIXME Function
    def set_query_function_full(self, query: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
    def set_unlink_function_full(self, unlink: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def start_task(self, func: typing.Callable[..., None], *user_data: typing.Any) -> bool: ...
    def sticky_events_foreach(self, foreach_func: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
...
class PadTemplate(Object):
    ...
    @classmethod
    def new(cls, name_template: str, direction: PadDirection, presence: PadPresence, caps: Caps) -> typing.Optional[PadTemplate]: ...
    @classmethod
    def new_from_static_pad_template_with_gtype(cls, pad_template: StaticPadTemplate, pad_type: typing.Type[typing.Any]) -> typing.Optional[PadTemplate]: ...
    @classmethod
    def new_with_gtype(cls, name_template: str, direction: PadDirection, presence: PadPresence, caps: Caps, pad_type: typing.Type[typing.Any]) -> typing.Optional[PadTemplate]: ...
...
class Plugin(Object):
    ...
    def __init__(self, name: typing.Optional[str] = ...,
                 parent: Object = ...) -> None: ...
    def add_dependency(self, env_vars: typing.Optional[typing.Sequence[str]], paths: typing.Optional[typing.Sequence[str]], names: typing.Optional[typing.Sequence[str]], flags: PluginDependencyFlags) -> None: ...
    def add_dependency_simple(self, env_vars: typing.Optional[str], paths: typing.Optional[str], names: typing.Optional[str], flags: PluginDependencyFlags) -> None: ...
    ...
    @staticmethod
    def register_static(major_version: int, minor_version: int, name: str, description: str, init_func: typing.Callable[[Plugin], bool], version: str, license: str, source: str, package: str, origin: str) -> bool: ...
    @staticmethod
    def register_static_full(major_version: int, minor_version: int, name: str, description: str, init_full_func: typing.Callable[..., bool], version: str, license: str, source: str, package: str, origin: str, *user_data: typing.Any) -> bool: ...
...
class Preset(GObject.GInterface):
    ...
    def set_meta(self, name: str, tag: str, value: typing.Optional[str] = None) -> bool: ...
...
class Promise(GObject.GBoxed):
    ...
    def new(cls) -> Promise: ...
    @classmethod
    def new_with_change_func(cls, func: typing.Callable[..., None], *user_data: typing.Any) -> Promise: ...
...
class ProxyPad(Pad):
    ...
    def __init__(self, direction: PadDirection = ...,
                 ...
                 parent: Object = ...) -> None: ...
    @staticmethod
    def chain_default(pad: Pad, parent: typing.Optional[Object], buffer: Buffer) -> FlowReturn: ...
    @staticmethod
    def chain_list_default(pad: Pad, parent: typing.Optional[Object], list: BufferList) -> FlowReturn: ...
    def get_internal(self) -> typing.Optional[ProxyPad]: ...
    @staticmethod
    def getrange_default(pad: Pad, parent: Object, offset: int, size: int) -> typing.Tuple[FlowReturn, Buffer]: ...
    @staticmethod
    def iterate_internal_links_default(pad: Pad, parent: typing.Optional[Object] = None) -> typing.Optional[Iterator]: ...
...
class Query(GObject.GBoxed):
    ...
    mini_object: MiniObject = ...
    type: QueryType = ...
    def add_allocation_meta(self, api: typing.Type[typing.Any], params: typing.Optional[Structure] = None) -> None: ...
    def add_allocation_param(self, allocator: typing.Optional[Allocator] = None, params: typing.Optional[AllocationParams] = None) -> None: ...
    def add_allocation_pool(self, pool: typing.Optional[BufferPool], size: int, min_buffers: int, max_buffers: int) -> None: ...
    def add_buffering_range(self, start: int, stop: int) -> bool: ...
    def add_scheduling_mode(self, mode: PadMode) -> None: ...
    def find_allocation_meta(self, api: typing.Type[typing.Any]) -> typing.Tuple[bool, int]: ...
    ...
    @classmethod
    def new_custom(cls, type: QueryType, structure: typing.Optional[Structure] = None) -> Query: ...
    @classmethod
    ...
    def parse_nth_allocation_meta(self, index: int) -> typing.Tuple[typing.Type[typing.Any], Structure]: ...
    def parse_nth_allocation_param(self, index: int) -> typing.Tuple[Allocator, AllocationParams]: ...
    def parse_nth_allocation_pool(self, index: int) -> typing.Tuple[BufferPool, int, int, int]: ...
    ...
    def set_nth_allocation_param(self, index: int, allocator: typing.Optional[Allocator] = None, params: typing.Optional[AllocationParams] = None) -> None: ...
    def set_nth_allocation_pool(self, index: int, pool: typing.Optional[BufferPool], size: int, min_buffers: int, max_buffers: int) -> None: ...
...
class Registry(Object):
    ...
    def feature_filter(self, filter: typing.Callable[..., bool], first: bool, *user_data: typing.Any) -> list[PluginFeature]: ...
    def find_feature(self, name: str, type: typing.Type[typing.Any]) -> typing.Optional[PluginFeature]: ...
    ...
    @staticmethod
    def get() -> Registry: ...
    def get_feature_list(self, type: typing.Type[typing.Any]) -> list[PluginFeature]: ...
    ...
    def plugin_filter(self, filter: typing.Callable[..., bool], first: bool, *user_data: typing.Any) -> list[Plugin]: ...
...
class Sample(GObject.GBoxed):
    ...
    @classmethod
    def new(cls, buffer: typing.Optional[Buffer] = None, caps: typing.Optional[Caps] = None, segment: typing.Optional[Segment] = None, info: typing.Optional[Structure] = None) -> Sample: ...
...
class Segment(GObject.GBoxed):
    ...
    duration: int = ...
    _gst_reserved: list[None] = ...
    def clip(self, format: Format, start: int, stop: int) -> typing.Tuple[bool, int, int]: ...
    def copy(self) -> Segment: ...
    def copy_into(self, dest: Segment) -> None: ...
    def do_seek(self, rate: float, format: Format, flags: SeekFlags, start_type: SeekType, start: int, stop_type: SeekType, stop: int) -> typing.Tuple[bool, bool]: ...
    def free(self) -> None: ...
    ...
    def position_from_running_time_full(self, format: Format, running_time: int) -> typing.Tuple[int, int]: ...
    def position_from_stream_time(self, format: Format, stream_time: int) -> int: ...
    def position_from_stream_time_full(self, format: Format, stream_time: int) -> typing.Tuple[int, int]: ...
    ...
    def to_running_time_full(self, format: Format, position: int) -> typing.Tuple[int, int]: ...
    def to_stream_time(self, format: Format, position: int) -> int: ...
    def to_stream_time_full(self, format: Format, position: int) -> typing.Tuple[int, int]: ...
...
class Stream(Object):
    ...
    @classmethod
    def new(cls, stream_id: typing.Optional[str], caps: typing.Optional[Caps], type: StreamType, flags: StreamFlags) -> Stream: ...
...
class Structure(GObject.GBoxed):
    ...
    def get_enum(self, fieldname: str, enumtype: typing.Type[typing.Any]) -> typing.Tuple[bool, int]: ...
    def get_field_type(self, fieldname: str) -> typing.Type[typing.Any]: ...
    def get_flags(self, fieldname: str, flags_type: typing.Type[typing.Any]) -> typing.Tuple[bool, int]: ...
    ...
    def has_field_typed(self, fieldname: str, type: typing.Type[typing.Any]) -> bool: ...
    def has_name(self, name: str) -> bool: ...
    ...
    @staticmethod
    def take(newstr: typing.Optional[Structure] = None) -> typing.Tuple[bool, Structure]: ...
...
class TagList(GObject.GBoxed):
    ...
    def get_date_time_index(self, tag: str, index: int) -> typing.Tuple[bool, DateTime]: ...
    ...
    def keys(self): ... # FIXME Function
    def merge(self, list2: typing.Optional[TagList], mode: TagMergeMode) -> typing.Optional[TagList]: ...
    def n_tags(self) -> int: ...
    @classmethod
    ...
    @staticmethod
    def replace(new_taglist: typing.Optional[TagList] = None) -> typing.Tuple[bool, TagList]: ...
    def set_scope(self, scope: TagScope) -> None: ...
    @staticmethod
    def take(new_taglist: typing.Optional[TagList] = None) -> typing.Tuple[bool, TagList]: ...
    def to_string(self) -> str: ...
...
class TagSetter(GObject.GInterface):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def add_tag_value(self, mode: TagMergeMode, tag: str, value: typing.Any) -> None: ...
...
class Task(Object):
    ...
    def set_enter_callback(self, enter_func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def set_leave_callback(self, leave_func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
...
class TaskPool(Object):
    ...
    def push(self, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
...
class Toc(GObject.GBoxed):
    ...
    def get_tags(self) -> typing.Optional[TagList]: ...
    def merge_tags(self, tags: typing.Optional[TagList], mode: TagMergeMode) -> None: ...
    @classmethod
...
class Tracer(Object):
    ...
    def __init__(self, params: str = ...,
                 ...
                 parent: Object = ...) -> None: ...
    @staticmethod
    def register(plugin: typing.Optional[Plugin], name: str, type: typing.Type[typing.Any]) -> bool: ...
...
class TypeFind(GObject.GPointer):
    ...
    @staticmethod
    def register(plugin: typing.Optional[Plugin], name: str, rank: int, func: typing.Callable[..., None], extensions: typing.Optional[str] = None, possible_caps: typing.Optional[Caps] = None, *data: typing.Any) -> bool: ...
...
class Uri(GObject.GBoxed):
    ...
    def append_path_segment(self, path_segment: typing.Optional[str] = None) -> bool: ...
    @staticmethod
    ...
    def get_query_string_ordered(self, keys: typing.Optional[list[str]] = None) -> typing.Optional[str]: ...
    ...
    @classmethod
    def new(cls, scheme: typing.Optional[str], userinfo: typing.Optional[str], host: typing.Optional[str], port: int, path: typing.Optional[str] = None, query: typing.Optional[str] = None, fragment: typing.Optional[str] = None) -> Uri: ...
    def new_with_base(self, scheme: typing.Optional[str], userinfo: typing.Optional[str], host: typing.Optional[str], port: int, path: typing.Optional[str] = None, query: typing.Optional[str] = None, fragment: typing.Optional[str] = None) -> Uri: ...
    ...
    def set_path_segments(self, path_segments: typing.Optional[list[str]] = None) -> bool: ...
    def set_path_string(self, path: str) -> bool: ...
    def set_port(self, port: int) -> bool: ...
    def set_query_string(self, query: typing.Optional[str] = None) -> bool: ...
    def set_query_table(self, query_table: typing.Optional[dict[str, str]] = None) -> bool: ...
    def set_query_value(self, query_key: str, query_value: typing.Optional[str] = None) -> bool: ...
