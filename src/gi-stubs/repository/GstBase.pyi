...
def type_find_helper_for_buffer(obj: typing.Optional[Gst.Object], buf: Gst.Buffer) -> typing.Tuple[typing.Optional[Gst.Caps], Gst.TypeFindProbability]: ...
def type_find_helper_for_buffer_with_caps(obj: typing.Optional[Gst.Object], buf: Gst.Buffer, caps: Gst.Caps) -> typing.Tuple[typing.Optional[Gst.Caps], Gst.TypeFindProbability]: ...
def type_find_helper_for_buffer_with_extension(obj: typing.Optional[Gst.Object], buf: Gst.Buffer, extension: typing.Optional[str] = None) -> typing.Tuple[typing.Optional[Gst.Caps], Gst.TypeFindProbability]: ...
def type_find_helper_for_data(obj: typing.Optional[Gst.Object], data: typing.Sequence[int]) -> typing.Tuple[typing.Optional[Gst.Caps], Gst.TypeFindProbability]: ...
def type_find_helper_for_data_with_caps(obj: typing.Optional[Gst.Object], data: typing.Sequence[int], caps: Gst.Caps) -> typing.Tuple[typing.Optional[Gst.Caps], Gst.TypeFindProbability]: ...
def type_find_helper_for_data_with_extension(obj: typing.Optional[Gst.Object], data: typing.Sequence[int], extension: typing.Optional[str] = None) -> typing.Tuple[typing.Optional[Gst.Caps], Gst.TypeFindProbability]: ...
def type_find_helper_for_extension(obj: typing.Optional[Gst.Object], extension: str) -> typing.Optional[Gst.Caps]: ...
def type_find_helper_get_range(obj: Gst.Object, parent: typing.Optional[Gst.Object], func: typing.Callable[[Gst.Object, typing.Optional[Gst.Object], int, int], typing.Tuple[Gst.FlowReturn, Gst.Buffer]], size: int, extension: typing.Optional[str] = None) -> typing.Tuple[typing.Optional[Gst.Caps], Gst.TypeFindProbability]: ...
def type_find_helper_get_range_full(obj: Gst.Object, parent: typing.Optional[Gst.Object], func: typing.Callable[[Gst.Object, typing.Optional[Gst.Object], int, int], typing.Tuple[Gst.FlowReturn, Gst.Buffer]], size: int, extension: typing.Optional[str] = None) -> typing.Tuple[Gst.FlowReturn, Gst.Caps, Gst.TypeFindProbability]: ...
def type_find_list_factories_for_caps(obj: typing.Optional[Gst.Object], caps: Gst.Caps) -> typing.Optional[list[Gst.TypeFindFactory]]: ...
...
class Adapter(GObject.Object):
    ...
    def masked_scan_uint32_peek(self, mask: int, pattern: int, offset: int, size: int) -> typing.Tuple[int, int]: ...
    @classmethod
    def new(cls) -> Adapter: ...
...
class Aggregator(Gst.Element):
    ...
    def do_peek_next_sample(self, aggregator_pad: AggregatorPad) -> typing.Optional[Gst.Sample]: ...
    ...
    def do_update_src_caps(self, caps: Gst.Caps) -> typing.Tuple[Gst.FlowReturn, Gst.Caps]: ...
    ...
    def selected_samples(self, pts: int, dts: int, duration: int, info: typing.Optional[Gst.Structure] = None) -> None: ...
...
class AggregatorClass(GObject.GPointer):
    ...
    create_new_pad: None = ...
    update_src_caps: typing.Callable[[Aggregator, Gst.Caps], typing.Tuple[Gst.FlowReturn, Gst.Caps]] = ...
    ...
    propose_allocation: typing.Callable[[Aggregator, AggregatorPad, Gst.Query, Gst.Query], bool] = ...
    negotiate: typing.Callable[[Aggregator], bool] = ...
    sink_event_pre_queue: typing.Callable[[Aggregator, AggregatorPad, Gst.Event], Gst.FlowReturn] = ...
    sink_query_pre_queue: typing.Callable[[Aggregator, AggregatorPad, Gst.Query], bool] = ...
    finish_buffer_list: typing.Callable[[Aggregator, Gst.BufferList], Gst.FlowReturn] = ...
    peek_next_sample: typing.Callable[[Aggregator, AggregatorPad], typing.Optional[Gst.Sample]] = ...
    _gst_reserved: list[None] = ...
...
class BaseParse(Gst.Element):
    ...
    def convert_default(self, src_format: Gst.Format, src_value: int, dest_format: Gst.Format) -> typing.Tuple[bool, int]: ...
    ...
    def do_handle_frame(self, frame: BaseParseFrame) -> typing.Tuple[Gst.FlowReturn, int]: ...
...
class BaseParseClass(GObject.GPointer):
    ...
    handle_frame: typing.Callable[[BaseParse, BaseParseFrame], typing.Tuple[Gst.FlowReturn, int]] = ...
...
class BaseSrc(Gst.Element):
    ...
    priv: BaseSrcPrivate = ...
    _gst_reserved: list[None] = ...
    def __init__(self, automatic_eos: bool = ...,
                 blocksize: int = ...,
                 do_timestamp: bool = ...,
                 num_buffers: int = ...,
                 typefind: bool = ...,
                 name: typing.Optional[str] = ...,
                 parent: Gst.Object = ...) -> None: ...
    def do_alloc(self, offset: int, size: int) -> typing.Tuple[Gst.FlowReturn, Gst.Buffer]: ...
    def do_create(self, offset: int, size: int) -> typing.Tuple[Gst.FlowReturn, Gst.Buffer]: ...
    def do_decide_allocation(self, query: Gst.Query) -> bool: ...
...
class BaseSrcClass(GObject.GPointer):
    ...
    create: typing.Callable[[BaseSrc, int, int], typing.Tuple[Gst.FlowReturn, Gst.Buffer]] = ...
    alloc: typing.Callable[[BaseSrc, int, int], typing.Tuple[Gst.FlowReturn, Gst.Buffer]] = ...
...
class BaseTransform(Gst.Element):
    ...
    def do_decide_allocation(self, query: Gst.Query) -> bool: ...
    def do_filter_meta(self, query: Gst.Query, api: typing.Type[typing.Any], params: Gst.Structure) -> bool: ...
    ...
    def do_prepare_output_buffer(self, input: Gst.Buffer) -> typing.Tuple[Gst.FlowReturn, Gst.Buffer]: ...
    ...
    def do_transform_size(self, direction: Gst.PadDirection, caps: Gst.Caps, size: int, othercaps: Gst.Caps) -> typing.Tuple[bool, int]: ...
    def get_allocator(self) -> typing.Tuple[Gst.Allocator, Gst.AllocationParams]: ...
    def get_buffer_pool(self) -> typing.Optional[Gst.BufferPool]: ...
...
class BaseTransformClass(GObject.GPointer):
    ...
    transform_caps: typing.Callable[[BaseTransform, Gst.PadDirection, Gst.Caps, Gst.Caps], Gst.Caps] = ...
    fixate_caps: typing.Callable[[BaseTransform, Gst.PadDirection, Gst.Caps, Gst.Caps], Gst.Caps] = ...
    ...
    filter_meta: typing.Callable[[BaseTransform, Gst.Query, typing.Type[typing.Any], Gst.Structure], bool] = ...
    propose_allocation: typing.Callable[[BaseTransform, Gst.Query, Gst.Query], bool] = ...
    transform_size: typing.Callable[[BaseTransform, Gst.PadDirection, Gst.Caps, int, Gst.Caps], typing.Tuple[bool, int]] = ...
    get_unit_size: typing.Callable[[BaseTransform, Gst.Caps], typing.Tuple[bool, int]] = ...
    ...
    prepare_output_buffer: typing.Callable[[BaseTransform, Gst.Buffer], typing.Tuple[Gst.FlowReturn, Gst.Buffer]] = ...
    copy_metadata: typing.Callable[[BaseTransform, Gst.Buffer, Gst.Buffer], bool] = ...
    transform_meta: typing.Callable[[BaseTransform, Gst.Buffer, Gst.Meta, Gst.Buffer], bool] = ...
    before_transform: typing.Callable[[BaseTransform, Gst.Buffer], None] = ...
    transform: typing.Callable[[BaseTransform, Gst.Buffer, Gst.Buffer], Gst.FlowReturn] = ...
    transform_ip: typing.Callable[[BaseTransform, Gst.Buffer], Gst.FlowReturn] = ...
    submit_input_buffer: typing.Callable[[BaseTransform, bool, Gst.Buffer], Gst.FlowReturn] = ...
    generate_output: typing.Callable[[BaseTransform], typing.Tuple[Gst.FlowReturn, Gst.Buffer]] = ...
    _gst_reserved: list[None] = ...
...
class CollectPads(Gst.Object):
    ...
    def __init__(self, name: typing.Optional[str] = ...,
                 parent: Gst.Object = ...) -> None: ...
    def add_pad(self, pad: Gst.Pad, size: int, destroy_notify: typing.Callable[[CollectData], None], lock: bool) -> typing.Optional[CollectData]: ...
    def available(self) -> int: ...
    def clip_running_time(self, cdata: CollectData, buf: Gst.Buffer, user_data: None) -> typing.Tuple[Gst.FlowReturn, Gst.Buffer]: ...
    ...
    def read_buffer(self, data: CollectData, size: int) -> typing.Optional[Gst.Buffer]: ...
    def remove_pad(self, pad: Gst.Pad) -> bool: ...
    def set_buffer_function(self, func: typing.Callable[..., Gst.FlowReturn], *user_data: typing.Any) -> None: ...
    def set_clip_function(self, clipfunc: typing.Callable[..., typing.Tuple[Gst.FlowReturn, Gst.Buffer]], *user_data: typing.Any) -> None: ...
    def set_compare_function(self, func: typing.Callable[..., int], *user_data: typing.Any) -> None: ...
    def set_event_function(self, func: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
    def set_flush_function(self, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def set_flushing(self, flushing: bool) -> None: ...
    def set_function(self, func: typing.Callable[..., Gst.FlowReturn], *user_data: typing.Any) -> None: ...
    def set_query_function(self, func: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
    def set_waiting(self, data: CollectData, waiting: bool) -> None: ...
    def src_event_default(self, pad: Gst.Pad, event: Gst.Event) -> bool: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
    def take_buffer(self, data: CollectData, size: int) -> typing.Optional[Gst.Buffer]: ...
